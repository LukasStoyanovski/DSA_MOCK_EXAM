...
private void printReverseHelper(ListNode node) {
 if (node != null) {
     printReverseHelper(node.getNext()); // Recurse to the end of the list
     System.out.println(node.getItem()); // Print items during unwinding phase
 }
}
